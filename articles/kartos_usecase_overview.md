...
(Cognitoは使い方のキャッチアップが結構難しかった記憶があります。)

デメリットとしては、サービスによってそれ相応のコストがかかる点です。
...
### ory kratosとは
何かいいOSSがないものかと探していて、1年ちょっと前くらいに見つけたのが ory kratos でした。

当時はまたv0.10くらいのバージョンでしたが、現在はv1.0.0がリリースされています。
...
oathkeeper自体がIAPとして振る舞うこともできますし、Traefikのような専用のプロキシ(エッジルーターというらしいです)からoathkeeperを呼び出して、IAPを実装することもできます。
...
![](https://github.com/YoshinoriSatoh/zenn/blob/master/images/kartos_usecase_overview/kratos%20usecase%20overview.png?raw=true)
